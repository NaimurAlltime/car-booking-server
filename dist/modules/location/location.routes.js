...
locationRoutes.post("/create", (0, validateRequest_middleware_1.default)(location_validation_1.default.createReq), 
// authorization(),
location_controller_1.default.createLocation);
...
locationRoutes.patch("/update/:id", (0, validateRequest_middleware_1.default)(location_validation_1.default.updateReq), 
// authorization(),
location_controller_1.default.updateLocation);
locationRoutes.delete("/delete/:id", 
// authorization(),
location_controller_1.default.deleteLocation);
